...
QT_MOC_LITERAL(1, 13, 12), // "colourChosen"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "colour"
QT_MOC_LITERAL(4, 34, 12) // "chooseColour"

    },
    "ColourButton\0colourChosen\0\0colour\0"
    "chooseColour"
};
...
void ColourButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colourChosen((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        case 1: _t->chooseColour(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ColourButton::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColourButton::colourChosen)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ColourButton::colourChosen(QColor _t1)
{
