...
void RunBlastSearchWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RunBlastSearchWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RunBlastSearchWorker::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject RunBlastSearchWorker::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_RunBlastSearchWorker.data,
    qt_meta_data_RunBlastSearchWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
