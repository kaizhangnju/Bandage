...
void BuildBlastDatabaseWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BuildBlastDatabaseWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (BuildBlastDatabaseWorker::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject BuildBlastDatabaseWorker::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_BuildBlastDatabaseWorker.data,
    qt_meta_data_BuildBlastDatabaseWorker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
